...
<nav class="navbar navbar-expand-md navbar-dark bg-info mb-4">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <li class="nav-item active">
            <button type="button" class="nav-link btn btn-primary" data-toggle="modal" data-target="#modalPost"><i class="fas fa-plus"></i> Post</button>
        </li>
        </ul>
    </div>
    <div class="nav justify-content-end">
        <li class="nav-item active">
            <a class="nav-link" href="#"><i class="fas fa-user-alt"  style="color: #FFFFFF"></i></a>
        </li>
    </div>
</nav>
<!-- end nav -->